  ...
  return (
    <article className="somos">
      ...
      <section className="row">
        <article className="offset-md-3 col-md-6 offset-sm-2 col-sm-8 offset-1 col-10">
      ...
      <section className="row somos-definicion">
        <article className="offset-md-2 col-md-4 offset-sm-2 col-sm-8 mb-5 offset-1 col-10">
          <CardValores
            title="Misión"
        ...
        <article className="offset-md-0 col-md-4 offset-sm-2 col-sm-8 mb-3 offset-1 col-10">
          <CardValores
            title="Valores"
