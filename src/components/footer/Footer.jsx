        ...
        <div className="col-12 col-lg-6">
          ...
          <div className="d-none d-sm-block">
            <div className="row">
              ...
              <div className="col-6 col-sm-4">
                <p className="footer-item">Limpieza de sarro</p>
              </div>
              <div className="col-6 col-sm-4">
                <p className="footer-item">Placas miorrelajantes</p>
              </div>
              <div className="col-6 col-sm-4">
                <p className="footer-item">Prótesis dentales</p>
              </div>
              <div className="col-6 col-sm-4">
                <p className="footer-item">Arreglos de caries</p>
              </div>
              <div className="col-6 col-sm-4">
                <p className="footer-item">Cirugía Maxilofacial</p>
              </div>
              <div className="col-6 col-sm-4">
                <p className="footer-item">Prevención y diagnóstico</p>
              </div>
              <div className="col-6 col-sm-4">
                <p className="footer-item">Tratamiento de conducto</p>
              </div>
              <div className="col-6 col-sm-4">
                <p className="footer-item">Ortodoncia</p>
              </div>
              <div className="col-6 col-sm-4">
                <p className="footer-item">Blanqueamientos dentales</p>
              </div>
              <div className="col-6 col-sm-4">
                <p className="footer-item">Carillas dentales</p>
              </div>
            </div>
          </div>
          {show && 
